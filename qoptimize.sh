...
do
    ...
    do
        ...
        python train_keras.py --epochs 50 --enc_dropout 0.1 --dec_dropout 0.1 \
        --weight_decay 1e-3 --lr 1e-3 --save_ver "enc_r$enc_r_bits enc_l$enc_l_bits dec_r$enc_r_bits dec_l$enc_l_bits" --dim_reduce_factor 2 \
        --batch_size 256 --mean_only --save_best --patience 15 --xyz_energy \
        --enc_a $enc_r_bits --enc_b $enc_l_bits --dec_a $enc_r_bits --dec_b $enc_l_bits
    done
done
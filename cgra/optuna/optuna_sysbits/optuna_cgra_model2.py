...
study = optuna.create_study(study_name="MODEL2_sys_bits_per_layer2(hopefully_final)", direction="minimize", storage=storage)  # Minimizing loss
...
for layer in layers:
    ...
    fig.write_html(f"model2_optuna_contour_{layer}.html")

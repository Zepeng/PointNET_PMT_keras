...
def objective(trial):
    ...
    TRAINING_EPOCHS = 2
    total_train_loss = []
    pbar = tqdm(total=TRAINING_EPOCHS, mininterval=10, disable=True)  # Disable tqdm for memory efficiency
...
study = optuna.create_study(direction="minimize")  # Use "minimize" since we're minimizing loss
